                            ...
                            <div className="site-section bg-left-half mb-2">
                                <div className="container owl-2-style">
                                  ...
                                  <div className="owl-carousel owl-2">
                                    <div className="media">
                                      <a href="#"><img src="dist-assets/images/safety_1.jpg" alt="Image" className="img-fluid"/></a>
                                      
                                    </div>
                                    <div className="media">
                                      <a href="#"><img src="dist-assets/images/safety_2.jpg" alt="Image" className="img-fluid"/></a>
                ...
                <div className="side-nav">
                    <div className="main-menu">
                        <ul className="metismenu" id="menu">
                            <li className="Ul_li--hover"><a className="active" href="dashboard"><i className="i-Bar-Chart text-20 mr-2 text-light"></i><span className="item-name text-15 text-light">Dashboard</span></a>                               
                            </li>
                            ...
                            <li className="Ul_li--hover"><a className="has-arrow" href="#"><i className="i-Library text-20 mr-2 text-light"></i><span className="item-name text-15 text-light">Safety Observation(PIOs) / Audits</span></a>
                                <ul className="mm-collapse">
                                    <li className="item-name"><a href="safety-observation"><i className="nav-icon i-Letter-Open text-light"></i><span className="item-name text-light">Safety Observation (PIOs)</span></a></li>                                    
                                    <li className="item-name"><a href="line-walk-audit"><i className="nav-icon i-File-Clipboard-File--Text text-light"></i><span className="item-name text-light">Line Walk (Individual Audit)</span></a></li>
                            ...
                            <li className="Ul_li--hover"><a href="#"><i className="i-File-Clipboard-File--Text text-20 mr-2 text-light"></i><span className="item-name text-15 text-light">My Raised Observation</span></a>
                                {/* <!-- <ul className="mm-collapse"> */}
                                    {/* <li className="item-name"><a href="pending-cases.html"><i className="nav-icon i-Receipt-4 text-light"></i><span className="item-name text-light">Pending Cases</span></a></li> */}
                                    {/* <li className="item-name"><a href="resolved-cases.html"><i className="nav-icon i-Receipt-4 text-light"></i><span className="item-name text-light">Resolved Cases</span></a></li>                                     */}
                                {/* </ul> --> */}
                            </li>
                            ...
                            <li className="Ul_li--hover"><a className="has-arrow" href="#"><i className="i-Administrator text-20 mr-2 text-light"></i><span className="item-name text-15 text-light">Admin</span></a>
                                <ul className="mm-collapse">
                                    <li className="item-name"><a href="line-manager-master"><i className="nav-icon i-File-Clipboard-Text--Image text-light"></i><span className="item-name text-light">Line Manager Master</span></a></li>
            ...
            <header className="main-header bg-white d-flex justify-content-between p-2">
                ...
                <div className="header-part-right">
                    ...
                    <div className="dropdown dropleft">
                        <img className="header-icon" src="dist-assets/images/profile.png"  id="dropdownMenuButton" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"/>
            ...
            <div className="main-content pt-4">
                ...
                <div className="row summary mb-3 pb-2">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="card card-icon-bg card-icon-bg-primary o-hidden my-2">
                            <div className="card-body">
                                <img src="dist-assets/images/today.png"/>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="card card-icon-bg card-icon-bg-primary o-hidden my-2">
                            <div className="card-body">
                                <img src="dist-assets/images/month.png"/>
                                <div className="content">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="card card-icon-bg card-icon-bg-primary o-hidden my-2">
                            <div className="card-body">
                                <img src="dist-assets/images/year.png"/>
                                <div className="content">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="card card-icon-bg card-icon-bg-primary o-hidden my-2">
                            <div className="card-body">
                                <img src="dist-assets/images/pending.png"/>
                                <div className="content">
                                ...
                                <div className="row">
                                    <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                        <div className="p-4 rounded d-flex align-items-center bg-secondary text-white">
                                            <img className="card-img mr-2" src="dist-assets/images/today-light.png" />
                                            <div>
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                        <div className="p-4 rounded d-flex align-items-center bg-secondary text-white">
                                            <img className="card-img mr-2" src="dist-assets/images/month-light.png" />
                                            <div>
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                        <div className="p-4 rounded d-flex align-items-center bg-secondary text-white">
                                            <img className="card-img mr-2" src="dist-assets/images/year-light.png" />
                                            <div>
                                    ...
                                    <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                        <div className="p-4 rounded d-flex align-items-center bg-secondary text-white">
                                            <img className="card-img mr-2" src="dist-assets/images/pending-light.png" />
                                            <div>
                        ...
                        <div className="card mb-4">
                            <div className="card-body">
                                <div className="card-title">                                    
                                    ...
                                    <div className="dropdown pull-right mx-2" style={{float: "right"}}>
                                        <button className="btn btn-primary dropdown-toggle" style={{width: "200px"}} id="dropdownMenuButton" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

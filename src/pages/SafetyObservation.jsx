...
<div  className="app-admin-wrap layout-sidebar-vertical sidebar-full">
        ...
        <div  className="main-content-wrap mobile-menu-content bg-off-white m-0">
            ...
            <div  className="main-content pt-4">
                ...
                {/* <!-----------Report Safety Observation Start------------>   */}
                                    ...
                                    <div  className="modal-body">
                                        <form action="" method="">
                                            <div  className="row">
                                                ...
                                                <div  className="col-md-4 form-group mb-3">
                                                    <label htmlFor="specify">Specify(If Not An Employee)</label>
                                                ...
                                                <div  className="col-md-4 form-group mb-3">
                                                    <label htmlFor="date_time">Date & Time Of Observation</label>
                                                ...
                                                <div  className="col-md-4 form-group mb-3">
                                                    ...
                                                    <select  className="form-select" id="riskCategory" name="riskCategory">
                                                        <option value = "default">Choose Risk Category</option>
                                                ...
                                                <div  className="col-md-4 form-group mb-3">
                                                    <label htmlFor="targetDate">Target Date (As Per Policy):</label>
                                                ...
                                                <div  className="col-md-4 form-group mb-3">
                                                    <label htmlFor="LineManager">JSPL Line Manager</label>
                                                ...
                                                <div  className="col-md-6 form-group mb-3">
                                                    <label htmlFor="suggest">Suggestions For Prevention (If Any)</label>
